...
joint_prompt = {
    "system": (
        "You are a content moderation assistant. You need to classify images with text "
        "across multiple dimensions: incivility, intolerance, and hatefulness. "
        "- Incivility: Rude, disrespectful or dismissive tone towards others as well as opinions expressed with antinormative intensity."
        "- Intolerance: Behaviors that are threatening to democracy and pluralism - such as prejudice, segregation, hateful or violent speech, and the use of stereotyping in order to disqualify others and groups."
        "- Hatefulness: Hateful content is defined as containing a direct or indirect attack on people based on characteristics, including ethnicity, race, nationality, immigration status, religion, caste, sex, gender identity, sexual orientation, and disability or disease."
    ),
    "user": (
        'Considering the image and its text: "{}". '
        'Classify this content on three dimensions: '
        '1. Incivility: Is this content civil or uncivil? '
        '2. Intolerance: Is this content tolerant or intolerant? '
        '3. Hatefulness: Is this content hateful or neutral? '
        'Respond in the format: '
        '"Incivility: [Civil/Uncivil], Intolerance: [Tolerant/Intolerant], Hatefulness: [Hateful/Neutral]"'
    )
}