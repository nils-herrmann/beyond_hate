...
def main():
    ...
    for run_idx, run in enumerate(tqdm(runs)):
        ...
        output_dir = project_root / cfg.out.runs / "fine" / current_time
        ...
        avg_accuracy = (evaluation["incivil"]['accuracy'] + evaluation["intolerance"]['accuracy']) / 2
        avg_f1 = (evaluation["incivil"]['f1_score'] + evaluation["intolerance"]['f1_score']) / 2
        avg_invalid_prediction_rate = (evaluation["incivil"]['invalid_prediction_rate'] + evaluation["intolerance"]['invalid_prediction_rate']) / 2
        ...
        for label in ["incivil", "intolerance"]:
            wandb.log({
